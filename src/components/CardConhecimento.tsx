...
function CardConhecimento() {
  return (
    <div className="flex flex-col md:grid grid-cols-2 md:w-2/3 text-sm md:text-base">
      <div className="relative border border-white p-4 md:p-8 flex flex-col gap-4 justify-center">
        <FaReact className="text-4xl md:text-8xl drop-shadow-[0px_0px_8px_rgba(94,211,243)] text-[#5ed3f3] absolute left-[-18px] top-[-18px] md:left-[-50px] md:top-[-50px] z-10" />
        <span className="md:text-2xl font-semibold">Next.js / React</span>
      ...
      <div className="row-span-2 relative border border-white p-4 md:p-8 flex flex-col gap-4 justify-center">
        <FaCss3 className="text-4xl md:text-8xl drop-shadow-[0px_0px_8px_rgba(94,211,243)] text-[#5ed3f3] absolute right-[-18px] bottom-[-18px] md:right-[-50px] md:bottom-[-50px] z-10" />
        <FaJs className="text-4xl md:text-8xl drop-shadow-[0px_0px_8px_rgba(240,219,85)] text-[#f0db55] absolute left-[-18px] top-[-18px] md:left-[-50px] md:top-[-50px] z-10" />
        <FaHtml5 className="text-4xl md:text-8xl drop-shadow-[0px_0px_8px_rgba(229,85,45)] text-[#e5552d] absolute right-[-18px] top-[-18px] md:right-[-50px] md:top-[-50px] z-10" />
      ...
      <div className="relative border border-white p-4 md:p-8 flex flex-col gap-4  justify-center">
        <FaNodeJs className="text-4xl md:text-8xl drop-shadow-[0px_0px_8px_rgba(144,197,63)] text-[#90c53f] absolute left-[-18px] bottom-[-18px] md:left-[-50px] md:bottom-[-50px] z-10" />
        <FaDatabase className="text-4xl md:text-8xl drop-shadow-[0px_0px_8px_rgba(255,255,255)] text-[#fff] absolute right-[-18px] bottom-[-18px] md:right-[-50px] md:bottom-[-50px] z-10" />
        <span className="md:text-2xl font-semibold">Node.js / MySQL</span>
        <p className="lg:text-justify ">
      ...
      <div className="col-span-2 relative border border-white p-4 md:p-8 flex flex-col gap-4  justify-center">
        <FaBootstrap className="text-4xl md:text-8xl drop-shadow-[0px_0px_8px_rgba(110,16,238)] text-[#6e10ee] absolute left-[-18px] bottom-[-18px] md:left-[-50px] md:bottom-[-50px] z-10" />
        <FaSass className="text-4xl md:text-8xl drop-shadow-[0px_0px_8px_rgba(199,100,148)] text-[#c76494] absolute right-[-18px] bottom-[-18px] md:right-[-50px] md:bottom-[-50px] z-10" />
        <span className="md:text-2xl font-semibold">
