...
const cardVariantsFromBotton: Variants = {
  offscreen: {
    y: 600,
  },
  onscreen: {
    ...
    <div className="flex flex-col md:grid grid-cols-2 md:w-2/3 text-sm md:text-base">
        ...
        >
          ...
          >
            ...
            <p className=" lg:text-justify ">
              Ao longo de três anos, tenho me dedicado ao estudo e
              aperfeiçoamento do React, React Native e Next.js, participando de
              cursos e projetos que envolvem essas bibliotecas. Através dessa
              jornada, adquiri proficiência em criar projetos responsivos e
              interativos, aplicando meus conhecimentos tanto em âmbito
      ...
      <div className="row-span-2 relative border border-white p-6 2xl:p-12 flex flex-col gap-4 justify-center">
        ...
        >
          <motion.div
            className=" flex flex-col items-center justify-center rounded-lg "
            variants={cardVariantsFromRight}
          >
            ...
            <p className="lg:text-justify ">
              ...
              JavaScript. Com dedicação incansável, participei de cursos e
              projetos que me permitiram dominar essas tecnologias fundamentais.
              Através da prática constante, aprimorei minha habilidade em criar
              interfaces interativas e responsivas, tornando-me capaz de
              projetar experiências envolventes para os usuários. Com HTML, dou
              forma ao conteúdo; com CSS, empresto estilo e design; e com
              JavaScript, trago interatividade e dinamismo às aplicações. Essas
              linguagens poderosas e complementares tornaram-me um desenvolvedor
              web completo, preparado para enfrentar novos desafios e oferecer
              soluções inovadoras para o mundo digital em constante evolução.
            </p>
          </motion.div>
        </motion.div>
      </div>
      <div className="relative border border-white p-6 2xl:p-12 flex flex-col gap-4  justify-center">
        ...
        >
          ...
          >
            ...
            <p className="lg:text-justify ">
              Em um ano de experiência, mergulhei no desenvolvimento web com
              Node.js e MySQL. Através de projetos desafiadores, explorei a
              criação de aplicações robustas no lado do servidor e a integração
              eficiente com o banco de dados MySQL. Com o Node.js, construí APIs
              interativas e versáteis, enquanto o MySQL garantiu o armazenamento
              e recuperação de dados de forma segura. Essa combinação poderosa
              de tecnologias me tornou um desenvolvedor web Fullstack pronto
              para enfrentar novos desafios e contribuir com projetos digitais
              inovadores.
            </p>
          </motion.div>
        </motion.div>
      ...
      <div className="col-span-2 relative border border-white p-6 2xl:p-12 flex flex-col gap-4  justify-center">
        ...
        >
          <motion.div
            className=" flex flex-col items-center justify-center rounded-lg "
            variants={cardVariantsFromBotton}
          >
            <span className="md:text-2xl font-semibold">
              Styled-components / Tailwind / Sass /Bootstrap
            </span>
            <p className="lg:text-justify ">
              Domino tecnologias essenciais como Styled-Components, Sass,
              Tailwind e Bootstrap. Através do uso habilidoso do
              Styled-Components e Sass, consigo criar estilos elegantes e
              reutilizáveis para minhas interfaces, proporcionando uma
              experiência visualmente atraente aos usuários. O Tailwind e o
              Bootstrap também são aliados valiosos, permitindo-me construir
              layouts responsivos e componentes prontos para uso de forma rápida
              e eficiente. Com essa combinação de ferramentas, sou capaz de
              desenvolver aplicações web modernas e atraentes, agregando valor
              aos projetos que abraço.
            </p>
          </motion.div>
        </motion.div>
      </div>
